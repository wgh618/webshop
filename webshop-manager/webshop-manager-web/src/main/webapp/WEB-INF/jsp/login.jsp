...
<div class="easyui-dialog" title="管理员登录" data-options="closable:false,draggable:false"
    ...
    <div style="margin-left: 50px;margin-top: 50px;">
        <form id="form" method="post" action="${pageContext.request.contextPath}/login" onsubmit="return
        login(this.form);">
            ...
            <div>
                <input type="submit" id="login" class="easyui-linkbutton" iconCls="icon-ok"
                       style="width:100px;height:32px;margin-left:
            50px" value="登录">
            </div>
        </form>
    </div>
